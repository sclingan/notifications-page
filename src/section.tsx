      ...
      <section>
         <ol>
             ...
             <li className='test'>
              ...
              <p className='post'><span className='user-name'>Rizky Hasanuddin</span> sent you a private message<span className='dot'></span></p>
             ...
             <li className='test'>
              ...
              <p className='post'><span className='user-name'>Kimberly Smith</span> commented on your picture<span className='dot'></span></p>
              <p className='post-time'>1 week ago</p>
             </li>

             <li className='test'>
              <img src={nathan} alt=""></img>
              <p className='post'><span className='user-name'>Nathan Peterson</span> reacted to your recent post 5 end-game strategies to increase your win rate<span className='dot'></span></p>
              <p className='post-time'>2 weeks ago</p>
              </li>

             <li className='test'>
              <img src={anna} alt=""></img>
              <p className='post'><span className='user-name'>Anna Kim</span> left the group Chess Club<span className='dot'></span></p>
              <p className='post-time'>2 weeks ago</p>
             </li>
         </ol>
      </section>
